...
const CameraScanScreen: React.FC<CameraScanScreenProps> = ({
  ...
  const fieldOccurrences = useRef<FieldOccurrences>({
    billingNumber: [],
    firstName: [],
    lastName: [],
    dateOfBirth: [],
      ...
      try {
        ...
        if (parsed) {
          ...
          const newOccurrences = {
            billingNumber: [
              ...fieldOccurrences.current.billingNumber,
              parsed.billingNumber,
            ].filter(Boolean),
            firstName: [
              ...fieldOccurrences.current.firstName,
              parsed.firstName,
            ].filter(Boolean),
            lastName: [
              ...fieldOccurrences.current.lastName,
              parsed.lastName,
            ].filter(Boolean),
            dateOfBirth: [
              ...fieldOccurrences.current.dateOfBirth,
              parsed.dateOfBirth,
            ].filter(Boolean),
            gender: [...fieldOccurrences.current.gender, parsed.gender].filter(
              Boolean
            ),
            admitDate: [
              ...fieldOccurrences.current.admitDate,
              parsed.serviceDate || "",
            ].filter(Boolean),
          };

          // Update the ref
          fieldOccurrences.current = newOccurrences;
