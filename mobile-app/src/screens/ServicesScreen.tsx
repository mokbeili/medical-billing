...
const ServicesScreen = ({ navigation }: any) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Sub-selection Modal using BillingCodeConfigurationModal component */}
      <BillingCodeConfigurationModal
        ...
        onSave={async (updatedSubSelection) => {
          if (!suggestionsForService || !currentCodeForSubSelection) return;
          try {
            // Add the codes to the service with updated subSelection
            const subs = codeSubSelections.map((s) =>
              s.codeId === currentCodeForSubSelection.id
                ? {
                    ...s,
                    ...updatedSubSelection,
            ...
            await addCodesToService(suggestionsForService, selectedCodes, subs);
        ...
        serviceDate={
          suggestionsForService?.serviceDate
            ? new Date(suggestionsForService.serviceDate)
                .toISOString()
                .split("T")[0]
            : undefined
        }
